...
![Figure X: Participant's self-reported cultural background.](Figures/ethnicity_barplot.png){width=80%}
...
![Figure X: Estimate of total household income received by all household members, from all sources, before taxes and deductions, in the past 12 months.](Figures/household_income_barplot.png){width=80%}
...
![Figure X: Approximate total value of savings and investments, including bank accounts, RRSPs, and financial investments.](Figures/savings_barplot.png){width=80%}
...
![](Tables/Table_airquality.png){width=100%}
...
![](Tables/Table_ndvi.png){width=100%}
...
![](Tables/Table_housing.png){width=100%}
...
![](Tables/Table_roads.png){width=100%}
...
![](Tables/Table_treecanopy.png){width=100%}
...
![](Tables/Table_percentveg.png){width=100%}
...
![Figure X: Annual average PM2.5 by household income group](Figures/PM2.5_by_income_group.png){width=80%}

\newpage

![Figure X: Annual average NO2 concentration by household income group](Figures/NO2_by_income_group.png){width=80%}

\newpage

![Figure X: Annual average SO2 concentration by household income group](Figures/SO2_by_income_group.png){width=80%}

\newpage

![Figure X: Annual average Ozone concentration by household income group](Figures/Ozone_by_income_group.png){width=80%}


## 3.2 NDVI (Greenness) by Income Group 


![Figure X: Maximum NDVI within 500 m by household income group](Figures/NDVI_by_income_group.png){width=80%}
...
![Figure X: Number of homes with condensation by household income group](Figures/Condensation_by_income_group.png){width=80%}


## 3.4 Tree Canopy Coverage By Income Group 

![Figure X: Vegetation cover (>5m) by income group](Figures/boxplot_vegetation_01.png){width=80%}

![Figure X: Vegetation cover (>5m) by income group, within 100m](Figures/boxplot_vegetation_02.png){width=80%}

![Figure X: Vegetation cover (>5m) by income group, within 250m](Figures/boxplot_vegetation_03.png){width=80%}

![Figure X: Vegetation cover (>5m) by income group, within 500m](Figures/boxplot_vegetation_04.png){width=80%}

![Figure X: Vegetation cover (>5m) by income group, within 1km](Figures/boxplot_vegetation_05.png){width=80%}
