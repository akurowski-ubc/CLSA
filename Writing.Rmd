...
```{r table_missingdata, echo=FALSE, fig.width=8,fig.height=5,out.width="100%"}
knitr::include_graphics("Tables/Table_missing.png")
```
...
# Environmental variables by income 
